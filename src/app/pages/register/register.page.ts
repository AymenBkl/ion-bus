...
export class RegisterPage implements OnInit {
  ...
  submit() {
    this.isLogin = true;
    this.user.phone = "353" + this.user.phone;
    this.api.register(this.user.email, this.user.password, this.user.first_name, this.user.last_name,this.user.phone).then((data) => {
      console.log(data);
      this.isLogin = false;
      if (data && data.uid) {
