...
export class OrderDetailPage implements OnInit {
  ...
  placeOrder() {
    ...
    this.api.updateOrder(this.id, param).then((data) => {
      ...
      const msg = this.util.translate('Your Order is ') + value + this.util.translate(' By ') + this.restName + this.util.translate(' and estimated delivery time is ')+ this.est_time ;
  ...
  changeStatus(value) {
    if (value === 'accepted') {
      ...
      this.api.updateOrderStatus(this.id, value).then((data) => {
        ...
        console.log('data', data);
        let msg = this.util.translate('Your Order is ') + value + this.util.translate(' By ') + this.restName 
        this.api.sendNotification(msg, 'Order ' + value, this.token).subscribe((data) => {
          console.log(data);
          this.util.hide();
          this.navCtrl.back();
