...
export class OrderDetailPage implements OnInit {
  ...
  placeOrder() {
    ...
    this.api.updateOrder(this.id, param).then((data) => {
      ...
      if (this.eta) {
        const msg = this.util.translate('Your Order is ') + value + this.util.translate(' By ') + this.restName + this.util.translate('. Order nymber is ') + this.orderid + ' and ' + this.util.translate(' estimated delivery time is ') +this.eta;
        alert(msg)
        ...
        const msg = this.util.translate('Your Order is ') + value + this.util.translate(' By ') + this.restName + this.orderid + ' and ' + this.util.translate(' estimated delivery time is ') + 'N/A'
        this.api.sendNotification(msg, 'Order ' + value, this.token).subscribe((data) => {
          console.log(data);
          this.util.hide();
          this.navCtrl.back();
