...
export class OrderDetailPage implements OnInit {
  ...
  placeOrder() {
    ...
    this.api.updateOrder(this.id, param).then((data) => {
      ...
      if (this.est_time) {
        const msg = this.util.translate('Your Order is ') + value + this.util.translate(' By ') + this.restName + this.util.translate(' estimated delivery time is ') +this.est_time;
        alert(msg)
